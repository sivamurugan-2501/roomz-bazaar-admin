...
class CreatePropertyMasterVarchar extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('property_master_varchar', function (Blueprint $table) {
            ...
            $table->string('value', 255)->comment('Value, here all varchar attributes details will be stored');
    ...
    {
        Schema::dropIfExists('property_master_varchar');
    }
}
