...
class CreatePropertyMasterDatetime extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('property_master_datetime', function (Blueprint $table) {
            ...
            $table->datetime('value')->comment('Value, here all datetime attributes details will be stored');
    ...
    {
        Schema::dropIfExists('property_master_datetime');
    }
}
