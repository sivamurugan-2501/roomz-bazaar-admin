...
class CreatePropertyMasterText extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('property_master_text', function (Blueprint $table) {
            ...
            $table->text('value')->comment('Value, here all text/textarea attributes value will be stored');
    ...
    {
        Schema::dropIfExists('property_master_text');
    }
}
