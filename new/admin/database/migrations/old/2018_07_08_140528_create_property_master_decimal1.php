...
class CreatePropertyMasterDecimal1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('property_master_decimal', function (Blueprint $table) {
            ...
            $table->decimal('value', 12, 2)->nullable()->comment('Value, here all decimal attributes detail will be stored');
    ...
    {
        Schema::dropIfExists('property_master_decimal');
    }
}
